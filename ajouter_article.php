...
<body>
    <h1 class="text-center text-bold text-lg my-8">Ajouter un nouvel article</h1>
    ...
    <?php endif; ?>
    <form action="ajouter_article_action.php" method="post" class="max-w-md mx-auto bg-white border border-gray-200 rounded-lg shadow p-5">
        <div class="mb-4">
            <label for="auteur" class="block text-gray-700 text-sm font-bold mb-2">Auteur</label>
            <input type="text" id="auteur" name="auteur" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>
        <div class="mb-4">
            <label for="image" class="block text-gray-700 text-sm font-bold mb-2">URL de l'image</label>
            <input type="text" id="image" name="image" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>
        <div class="mb-4">
    ...
    <input type="date" id="date" name="date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        ...
        <div class="mb-4">
            ...
            <textarea id="contenu" name="contenu" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"></textarea>
        </div>
        <div class="flex justify-end">
            <button type="submit" class="bg-blue-500 text-white px-3 py-1 rounded-full">Ajouter</button>
        </div>
    </form>
</body>
